    ...
    return (
        ...
        <section className="fifty-fifty-portfolio" id='portfolio'>
            <div className='text-and-btn'>
                <div>
                    <p>
                        Our portfolio showcases <a href='/portfolio'>diverse web designs</a>, each aligned with the unique needs and goals of our clients.                </p>
                    <p>
                                ...
                                {images.map((img, idx) => (
                                    <div className="carousel-slide" key={idx} style={{ minWidth: '680px', height: '360px' }}>
                                        <img
                                            ...
                                            style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '14px', background: '#111', display: 'block' }}
                                        />
                                    </div>
                                ))}
                            </div>
